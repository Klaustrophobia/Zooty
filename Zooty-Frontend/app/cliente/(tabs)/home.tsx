...
const SERVICES = [
  { id: '1', label: 'Veterinario',  sub: 'Salud y vacunas',   color: '#E8F7F5', iconBg: Colors.primary },
  { id: '2', label: 'Peluquería',   sub: 'Estética animal',   color: '#FFF4EE', iconBg: '#F4845F' },
  { id: '3', label: 'Guardería',    sub: 'Cuidado diario',    color: '#E8F7F5', iconBg: Colors.primary },
  { id: '4', label: 'Paseador',     sub: 'Ejercicio activo',  color: '#FFF4EE', iconBg: '#F4845F' },
];

const PROFESSIONALS = [
  { id: '1', name: 'Clinivet Dr. García', specialty: 'Medicina General', distance: '0.8 km', rating: 4.9 },
  { id: '2', name: 'Spa Canino Burbujas', specialty: 'Estética y Baño',   distance: '1.2 km', rating: 4.7 },
  { id: '3', name: 'Carlos Paseos',       specialty: 'Paseos grupales',   distance: '0.5 km', rating: 5.0 },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.servicesGrid}>
          {SERVICES.map((svc) => (
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <View style={[styles.serviceIconCircle, { backgroundColor: svc.iconBg }]}>
                <Text style={styles.serviceIcon}>{svc.label.charAt(0)}</Text>
              </View>
        ...
        {PROFESSIONALS.map((pro) => (
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            onPress={() => router.push(`/citas/agendar?pro=${pro.id}`)}
          >
            ...
            <View style={styles.proInfo}>
              <View style={styles.proNameRow}>
                ...
                <View style={styles.ratingPill}>
                  ...
                  <Text style={styles.ratingValue}>{pro.rating}</Text>
                </View>
              </View>
                          ...
                          {['Perro', 'Gato', 'Otro'].map((type) => (
                            ...
                            >
                              <Text style={[
                                ...
                                newPetType === type && styles.typeButtonTextActive
                              ]}>
                                {type}
                              </Text>
                            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  notifBtn: {
    ...
    shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: wp(6),
    shadowOffset: { width: 0, height: hp(2) }, elevation: 2, position: 'relative',
  },
  ...
  /* Mascotas */
  petsRow: { marginHorizontal: -Spacing.lg, paddingHorizontal: Spacing.lg, marginBottom: Spacing.md },
  ...
  petCircle: {
    ...
    shadowRadius: wp(6), shadowOffset: { width: 0, height: hp(2) }, elevation: 2,
    marginBottom: hp(6),
  },
  ...
  petAddCircle: {
    ...
    alignItems: 'center', justifyContent: 'center', marginBottom: hp(6),
  },
  petAddIcon: { fontSize: wp(30), color: Colors.textLight, fontWeight: '300' },
  petName: { fontSize: FontSize.xs, color: Colors.textMedium, fontWeight: '600' },
  ...
  serviceCard: {
    ...
    shadowRadius: wp(8), shadowOffset: { width: 0, height: hp(2) }, elevation: 1,
  },
  serviceIconCircle: {
  ...
  serviceLabel: { fontSize: FontSize.md, fontWeight: '700', color: Colors.textDark, marginBottom: hp(2) },
  ...
  proName: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.textDark, flex: 1 },
  ratingPill: {
    flexDirection: 'row', alignItems: 'center',
  ...
  ratingValue: { fontSize: FontSize.xs, fontWeight: '700', color: Colors.textDark },
  proSpecialty: { fontSize: FontSize.xs, color: Colors.textMedium, marginBottom: hp(4) },
  ...
  reserveBtnText: { color: Colors.white, fontSize: FontSize.xs, fontWeight: '700' },
